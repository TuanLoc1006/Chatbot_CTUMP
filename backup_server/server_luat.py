...
def faiss_index():
    ...
    naive_chunk_vectorstore.save_local('E:\\CTU\\luanvan\\test_rag_sematic\\docs_index_luat_hon_nhan')
...
def initialize_rag_chain():
    ...
    naive_chunk_vectorstore = FAISS.load_local(
        'E:\\CTU\\luanvan\\test_rag_sematic\\docs_index_luat_hon_nhan', 
    ...
    rag_template = """
    Bạn là một chuyên gia về luật hôn nhân và gia đình Việt Nam. Xin vui lòng cho tôi biết số chương, mục và tên điều trong Luật Hôn nhân và Gia đình Việt Nam tương ứng với nội dung câu hỏi và giải thích theo luật.
